    ...
    function batteryPins(p, def_neg, def_pos, silk_layer, font_effect) {
      if(p.batteryPins) {
        return `
          ...
          (pad 25 thru_hole roundrect (at -16.51 ${def_pos}7.62 0) (size 1.5 1.5) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) (roundrect_rratio 0.25) ${p.Bplus.str})
          (pad 25 thru_hole roundrect (at -16.51 ${def_neg}7.62 0) (size 1.5 1.5) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) (roundrect_rratio 0.25) ${p.Bminus.str})
        `
      } else {
        return ''
      }
